	...
	<form class="form-horizontal form" type="GET" action="">
	  <div class="col-md-6 col-md-offset-3">   	
		...
		<div class="box row-fluid">	
			...
			<div class="step">
				  <div class="form-group">
				    <label for="unit_6817_1" class="col-sm-2 control-label">6817 Crew Day 1</label>
				    <div class="col-sm-10">
				  ...
				  <div class="form-group">
				    <label for="unit_6817_2" class="col-sm-2 control-label">6817 Crew Day 2</label>
				    <div class="col-sm-10">
			...
			<div class="step">
				  <div class="form-group">
				    <label for="unit_6827_1" class="col-sm-2 control-label">6827 Crew Day 1</label>
				    <div class="col-sm-10">
				  ...
				  <div class="form-group">
				    <label for="unit_6827_2" class="col-sm-2 control-label">6827 Crew Day 2</label>
				    <div class="col-sm-10">
			...
			<div class="step">
				  <div class="form-group">
				    <label for="unit_6837_1" class="col-sm-2 control-label">6837 Crew Day 1</label>
				    <div class="col-sm-10">
				  ...
				  <div class="form-group">
				    <label for="unit_6837_2" class="col-sm-2 control-label">6837 Crew Day 2</label>
				    <div class="col-sm-10">
			...
			<div class="step">
				  <div class="form-group">
				    <label for="unit_6847_1" class="col-sm-2 control-label">6847 Crew Day 1</label>
				    <div class="col-sm-10">
				  ...
				  <div class="form-group">
				    <label for="unit_6847_2" class="col-sm-2 control-label">6847 Crew Day 2</label>
				    <div class="col-sm-10">
			...
			<div class="step">
				<div class="form-group">
				  <label class="col-sm-2 control-label">Oxygen bottles checked station 1</label>
				     <div class="col-sm-10">
				...
				<div class="form-group">
				  <label class="col-sm-2 control-label">Oxygen bottles checked station 2</label>
				     <div class="col-sm-10">
				...
				<div class="form-group">
				  <label class="col-sm-4 control-label">Overtime checked and logged</label>
				     <div class="col-sm-8">
				...
				<div class="form-group">
				  <label class="col-sm-4 control-label">Supplies checked and requested</label>
				     <div class="col-sm-8">
			...
			<div class="step">
				  <div class="form-group">
				    <label for="duties_1" class="col-sm-3 control-label">Extra Duties Station 1</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="duties_2" class="col-sm-3 control-label">Extra Duties Station 2</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="other" class="col-sm-3 control-label">Other Items To Report</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="training" class="col-sm-3 control-label">Trainings and/or Meetings Attended</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="pr" class="col-sm-3 control-label">PR Events Attended</label>
				    <div class="col-sm-9">
